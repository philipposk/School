...
const UserProfileManager = {
    ...
    renderFriendsModal() {
        // Ensure default friends are initialized
                            ...
                            ? `<div class="friends-grid">
                                ${currentFriends.map(profile => `
                                    <div class="friend-card" onclick="closeFriendsModal(); viewUserProfile('${profile.email}');">
                                        ...
                                        <button class="btn btn-secondary btn-sm" onclick="event.stopPropagation(); removeFriend('${profile.email}'); renderFriendsModal();">Unfollow</button>
                                    </div>
                                `).join('')}
                            </div>`
...
function removeFriend(email) {
    UserProfileManager.removeFriend(email);
}
